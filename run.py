...
This script watches for changes in the {{cookiecutter.package_name}}/ template directory
...
class ChangeHandler(FileSystemEventHandler):
    ...
    def on_any_event(self, event):
        ...
        if current_time - self.last_run > self.debounce_period:
            ...
            try:
                # The output directory is in the repo root (matches cookiecutter.json package_name)
